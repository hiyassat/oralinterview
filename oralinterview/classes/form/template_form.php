...
class mod_oralinterview_template_form extends moodleform {
    public function definition() {
        ...
        // Job title is auto-derived from the activity job selection; do not allow manual edits.
        $mform->addElement('static', 'jobtitle_display', get_string('template_jobtitle', 'oralinterview'), '');
