...
foreach ($evaluations as $evaluation) {
    ...
    foreach ($questions as $question) {
        ...
        $rows[] = [
            ...
            'score' => $scorevalue !== null ? format_float($scorevalue, 2) : get_string('notapplicable'),
...
echo html_writer::tag('h3', get_string('session_finalscore', 'oralinterview') . ': ' . ($session->finalscore !== null ? format_float($session->finalscore, 2) . ' (' . format_float($session->finalpercent ?? 0, 2) . '%)' : get_string('notapplicable')));
